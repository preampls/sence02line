...
public class ArrayUtils {
    ...
    private static Object realSubArray(Object array, int startIndexInclusive, int endIndexExclusive) {
        ...
        Object subArray = java.lang.reflect.Array.newInstance(type, newSize);
    ...
    private static Object realAddOne(Object array, Object element, Class newArrayComponentType) {
        ...
        if (array != null) {
            ...
            newArray = java.lang.reflect.Array.newInstance(array.getClass().getComponentType(), arrayLength + 1);
    ...
    private static Object realAddArr(Object array1, Object array2) {
        ...
        Object joinedArray = java.lang.reflect.Array.newInstance(array1.getClass().getComponentType(), len1 + len2);
    ...
    private static Object realAdd(Object array, int index, Object element, Class clss) {
        if (array == null) {
            ...
            Object joinedArray = java.lang.reflect.Array.newInstance(clss, 1);
        ...
        Object result = java.lang.reflect.Array.newInstance(clss, length + 1);
    ...
    public static int indexOf(double[] array, double valueToFind, int startIndex) {
        if (ls.example.t.zero2line.util.ArrayUtils.isEmpty(array)) {
            return INDEX_NOT_FOUND;
        }
        if (startIndex < 0) {
            startIndex = 0;
    ...
    public static <T> java.util.List<T> asUnmodifiableList(T... array) {
        return java.util.Collections.unmodifiableList(asList(array));
    }
    ...
    public static <T> java.util.List<T> asLinkedList(T... array) {
        java.util.List<T> list = new java.util.LinkedList<>();
        if (array == null || array.length == 0) return list;
        list.addAll(java.util.Arrays.asList(array));
        return list;
    }

    public static <T> void sort(T[] array, java.util.Comparator<? super T> c) {
     ...
     */
    public static <E> void forAllDo(Object array, ls.example.t.zero2line.util.ArrayUtils.Closure<E> closure) {
