...
public final class LunarUtils {
     ...
     * @return 公历
     */
    public static ls.example.t.zero2line.util.LunarUtils.Solar lunar2Solar(final ls.example.t.zero2line.util.LunarUtils.Lunar lunar) {
     ...
     * @return 阴历
     */
    public static ls.example.t.zero2line.util.LunarUtils.Lunar solar2Lunar(final ls.example.t.zero2line.util.LunarUtils.Solar solar) {
        ls.example.t.zero2line.util.LunarUtils.Lunar lunar = new ls.example.t.zero2line.util.LunarUtils.Lunar();
    ...
    private static ls.example.t.zero2line.util.LunarUtils.Solar solarFromInt(final long g) {
        ...
        ls.example.t.zero2line.util.LunarUtils.Solar solar = new ls.example.t.zero2line.util.LunarUtils.Solar();
