...
public final class SizeUtils {
     ...
     */
    public static void forceGetViewSize(final android.view.View view, final ls.example.t.zero2line.util.SizeUtils.onGetSizeListener listener) {
     ...
     * @return the width of view
     */
    public static int getMeasuredWidth(final android.view.View view) {
     ...
     * @return the height of view
     */
    public static int getMeasuredHeight(final android.view.View view) {
     ...
     */
    public static int[] measureView(final android.view.View view) {
        ...
        int widthSpec = android.view.ViewGroup.getChildMeasureSpec(0, 0, lp.width);
        int lpHeight = lp.height;
        int heightSpec;
        if (lpHeight > 0) {
            heightSpec = android.view.View.MeasureSpec.makeMeasureSpec(lpHeight, android.view.View.MeasureSpec.EXACTLY);
        } else {
            heightSpec = android.view.View.MeasureSpec.makeMeasureSpec(0, android.view.View.MeasureSpec.UNSPECIFIED);
        }
