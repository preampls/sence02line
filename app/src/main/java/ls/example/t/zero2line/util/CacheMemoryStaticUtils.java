...
public final class CacheMemoryStaticUtils {
     ...
     */
    public static void put(@android.support.annotation.NonNull final String key, final Object value) {
     ...
     */
    public static void put(@android.support.annotation.NonNull final String key, final Object value, int saveTime) {
     ...
     */
    public static <T> T get(@android.support.annotation.NonNull final String key) {
     ...
     */
    public static <T> T get(@android.support.annotation.NonNull final String key, final T defaultValue) {
     ...
     */
    public static Object remove(@android.support.annotation.NonNull final String key) {
    ...
    public static void put(@android.support.annotation.NonNull final String key,
                           final Object value,
                           @android.support.annotation.NonNull final CacheMemoryUtils cacheMemoryUtils) {
     ...
     * @return the value if cache exists or null otherwise
     */
    public static <T> T get(@android.support.annotation.NonNull final String key, @android.support.annotation.NonNull final CacheMemoryUtils cacheMemoryUtils) {
     ...
     * @return the count of cache
     */
    public static int getCacheCount(@android.support.annotation.NonNull final CacheMemoryUtils cacheMemoryUtils) {
     ...
     * @return {@code true}: success<br>{@code false}: fail
     */
    public static Object remove(@android.support.annotation.NonNull final String key, @android.support.annotation.NonNull final CacheMemoryUtils cacheMemoryUtils) {
     ...
     * @param cacheMemoryUtils The instance of {@link CacheMemoryUtils}.
     */
    public static void clear(@android.support.annotation.NonNull final CacheMemoryUtils cacheMemoryUtils) {
