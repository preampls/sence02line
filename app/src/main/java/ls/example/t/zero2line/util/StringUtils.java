...
public final class StringUtils {
     ...
     * @return the string value associated with a particular resource ID.
     */
    public static String getString(@android.support.annotation.StringRes int id) {
        try {
     ...
     * @return the string value associated with a particular resource ID.
     */
    public static String getString(@android.support.annotation.StringRes int id, Object... formatArgs) {
        try {
     ...
     */
    public static String[] getStringArray(@android.support.annotation.ArrayRes int id) {
        try {
