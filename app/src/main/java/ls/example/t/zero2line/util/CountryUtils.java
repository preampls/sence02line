...
public class CountryUtils {
    ...
    private static java.util.HashMap<String, String> countryCodeMap;
    ...
    public static String getCountryBySim() {
        android.telephony.TelephonyManager manager = (android.telephony.TelephonyManager) Utils.getApp().getSystemService(android.content.Context.TELEPHONY_SERVICE);
        if (manager != null) {
    ...
    private static java.util.HashMap<String, String> getCountryCodeFromMap() {
        if (countryCodeMap == null) {
            countryCodeMap = new java.util.HashMap<>(256);
