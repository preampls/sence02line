...
public final class ResourceUtils {
     ...
     * @return the content of file in assets
     */
    public static java.util.List<String> readAssets2List(final String assetsPath) {
     ...
     * @return {@code true}: success<br>{@code false}: fail
     */
    public static boolean copyFileFromRaw(@android.support.annotation.RawRes final int resId, final String destFilePath) {
     ...
     * @return the content of resource in raw
     */
    public static String readRaw2String(@android.support.annotation.RawRes final int resId) {
     ...
     * @return the content of resource in raw
     */
    public static String readRaw2String(@android.support.annotation.RawRes final int resId, final String charsetName) {
        java.io.InputStream is = Utils.getApp().getResources().openRawResource(resId);
        byte[] bytes = is2Bytes(is);
        if (bytes == null) return null;
        if (isSpace(charsetName)) {
            return new String(bytes);
     ...
     * @return the content of file in assets
     */
    public static java.util.List<String> readRaw2List(@android.support.annotation.RawRes final int resId) {
    ...
    private static boolean writeFileFromIS(final java.io.File file,
        ...
        try {
            os = new java.io.BufferedOutputStream(new java.io.FileOutputStream(file, append));
    ...
    private static java.util.List<String> is2List(final java.io.InputStream is,
                                                  final String charsetName) {
        ...
        try {
            ...
            if (isSpace(charsetName)) {
                ...
                reader = new java.io.BufferedReader(new java.io.InputStreamReader(is, charsetName));
            }
            String line;
