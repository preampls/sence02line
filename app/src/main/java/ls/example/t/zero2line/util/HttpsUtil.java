...
public final class HttpsUtil {
    ...
    private static String doHttpAction(String data, boolean json, boolean post, String url) {
        ...
        try {
            java.net.URL sUrl = new java.net.URL(url);
            connection = (java.net.HttpURLConnection) sUrl.openConnection();
            ...
            os = new java.io.DataOutputStream(connection.getOutputStream());
