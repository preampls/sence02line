...
public class PathUtils {
    ...
    public static String getRootPath() {
        return getAbsolutePath(android.os.Environment.getRootDirectory());
    }
    ...
    public static String getDataPath() {
        return getAbsolutePath(android.os.Environment.getDataDirectory());
    }
    ...
    public static String getDownloadCachePath() {
        return getAbsolutePath(android.os.Environment.getDownloadCacheDirectory());
    }
    ...
    public static String getExternalStoragePath() {
        ...
        return getAbsolutePath(android.os.Environment.getExternalStorageDirectory());
    }
    ...
    public static String getExternalMusicPath() {
        if (isExternalStorageDisable()) return "";
        return getAbsolutePath(android.os.Environment.getExternalStoragePublicDirectory(android.os.Environment.DIRECTORY_MUSIC));
    }
    ...
    public static String getExternalPodcastsPath() {
        if (isExternalStorageDisable()) return "";
        return getAbsolutePath(android.os.Environment.getExternalStoragePublicDirectory(android.os.Environment.DIRECTORY_PODCASTS));
    }
    ...
    public static String getExternalRingtonesPath() {
        if (isExternalStorageDisable()) return "";
        return getAbsolutePath(android.os.Environment.getExternalStoragePublicDirectory(android.os.Environment.DIRECTORY_RINGTONES));
    }
    ...
    public static String getExternalAlarmsPath() {
        if (isExternalStorageDisable()) return "";
        return getAbsolutePath(android.os.Environment.getExternalStoragePublicDirectory(android.os.Environment.DIRECTORY_ALARMS));
    }
    ...
    public static String getExternalNotificationsPath() {
        if (isExternalStorageDisable()) return "";
        return getAbsolutePath(android.os.Environment.getExternalStoragePublicDirectory(android.os.Environment.DIRECTORY_NOTIFICATIONS));
    }
    ...
    public static String getExternalPicturesPath() {
        if (isExternalStorageDisable()) return "";
        return getAbsolutePath(android.os.Environment.getExternalStoragePublicDirectory(android.os.Environment.DIRECTORY_PICTURES));
    }
    ...
    public static String getExternalMoviesPath() {
        if (isExternalStorageDisable()) return "";
        return getAbsolutePath(android.os.Environment.getExternalStoragePublicDirectory(android.os.Environment.DIRECTORY_MOVIES));
    }
    ...
    public static String getExternalDownloadsPath() {
        if (isExternalStorageDisable()) return "";
        return getAbsolutePath(android.os.Environment.getExternalStoragePublicDirectory(android.os.Environment.DIRECTORY_DOWNLOADS));
    }
    ...
    public static String getExternalDcimPath() {
        if (isExternalStorageDisable()) return "";
        return getAbsolutePath(android.os.Environment.getExternalStoragePublicDirectory(android.os.Environment.DIRECTORY_DCIM));
    }
    ...
    public static String getExternalDocumentsPath() {
        ...
        if (android.os.Build.VERSION.SDK_INT < android.os.Build.VERSION_CODES.KITKAT) {
            return getAbsolutePath(android.os.Environment.getExternalStorageDirectory()) + "/Documents";
        }
        return getAbsolutePath(android.os.Environment.getExternalStoragePublicDirectory(android.os.Environment.DIRECTORY_DOCUMENTS));
    }
    ...
    public static String getExternalAppDataPath() {
        if (isExternalStorageDisable()) return "";
        java.io.File externalCacheDir = Utils.getApp().getExternalCacheDir();
    ...
    public static String getExternalAppMusicPath() {
        if (isExternalStorageDisable()) return "";
        return getAbsolutePath(Utils.getApp().getExternalFilesDir(android.os.Environment.DIRECTORY_MUSIC));
    }
    ...
    public static String getExternalAppPodcastsPath() {
        if (isExternalStorageDisable()) return "";
        return getAbsolutePath(Utils.getApp().getExternalFilesDir(android.os.Environment.DIRECTORY_PODCASTS));
    }
    ...
    public static String getExternalAppRingtonesPath() {
        if (isExternalStorageDisable()) return "";
        return getAbsolutePath(Utils.getApp().getExternalFilesDir(android.os.Environment.DIRECTORY_RINGTONES));
    }
    ...
    public static String getExternalAppAlarmsPath() {
        if (isExternalStorageDisable()) return "";
        return getAbsolutePath(Utils.getApp().getExternalFilesDir(android.os.Environment.DIRECTORY_ALARMS));
    }
    ...
    public static String getExternalAppNotificationsPath() {
        if (isExternalStorageDisable()) return "";
        return getAbsolutePath(Utils.getApp().getExternalFilesDir(android.os.Environment.DIRECTORY_NOTIFICATIONS));
    }
    ...
    public static String getExternalAppPicturesPath() {
        if (isExternalStorageDisable()) return "";
        return getAbsolutePath(Utils.getApp().getExternalFilesDir(android.os.Environment.DIRECTORY_PICTURES));
    }
    ...
    public static String getExternalAppMoviesPath() {
        if (isExternalStorageDisable()) return "";
        return getAbsolutePath(Utils.getApp().getExternalFilesDir(android.os.Environment.DIRECTORY_MOVIES));
    }
    ...
    public static String getExternalAppDownloadPath() {
        if (isExternalStorageDisable()) return "";
        return getAbsolutePath(Utils.getApp().getExternalFilesDir(android.os.Environment.DIRECTORY_DOWNLOADS));
    }
    ...
    public static String getExternalAppDcimPath() {
        if (isExternalStorageDisable()) return "";
        return getAbsolutePath(Utils.getApp().getExternalFilesDir(android.os.Environment.DIRECTORY_DCIM));
    }
    ...
    public static String getExternalAppDocumentsPath() {
        ...
        return getAbsolutePath(Utils.getApp().getExternalFilesDir(android.os.Environment.DIRECTORY_DOCUMENTS));
    }
    ...
    private static String getAbsolutePath(final java.io.File file) {
        if (file == null) return "";
