...
public final class RegexUtils {
    ...
    private final static android.support.v4.util.SimpleArrayMap<String, String> CITY_MAP = new android.support.v4.util.SimpleArrayMap<>();
     ...
     * @return the list of input matches the regex
     */
    public static java.util.List<String> getMatches(final String regex, final CharSequence input) {
