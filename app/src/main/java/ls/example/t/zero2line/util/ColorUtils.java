...
public final class ColorUtils {
     ...
     */
    public static int getColor(@android.support.annotation.ColorRes int id) {
        return android.support.v4.content.ContextCompat.getColor(Utils.getApp(), id);
    }
     ...
     */
    public static int setAlphaComponent(@android.support.annotation.ColorInt final int color,
                                        @android.support.annotation.IntRange(from = 0x0, to = 0xFF) int alpha) {
     ...
     * @return the {@code color} with {@code alpha} component
     */
    public static int setAlphaComponent(@android.support.annotation.ColorInt int color,
                                        @android.support.annotation.FloatRange(from = 0, to = 1) float alpha) {
     ...
     */
    public static int setRedComponent(@android.support.annotation.ColorInt int color,
                                      @android.support.annotation.IntRange(from = 0x0, to = 0xFF) int red) {
     ...
     */
    public static int setRedComponent(@android.support.annotation.ColorInt int color,
                                      @android.support.annotation.FloatRange(from = 0, to = 1) float red) {
     ...
     */
    public static int setGreenComponent(@android.support.annotation.ColorInt int color,
                                        @android.support.annotation.IntRange(from = 0x0, to = 0xFF) int green) {
     ...
     */
    public static int setGreenComponent(@android.support.annotation.ColorInt int color,
                                        @android.support.annotation.FloatRange(from = 0, to = 1) float green) {
     ...
     */
    public static int setBlueComponent(@android.support.annotation.ColorInt int color,
                                       @android.support.annotation.IntRange(from = 0x0, to = 0xFF) int blue) {
     ...
     */
    public static int setBlueComponent(@android.support.annotation.ColorInt int color,
                                       @android.support.annotation.FloatRange(from = 0, to = 1) float blue) {
     ...
     */
    public static int string2Int(@android.support.annotation.NonNull String colorString) {
     ...
     * @return color-string
     */
    public static String int2RgbString(@android.support.annotation.ColorInt int colorInt) {
     ...
     * @return color-string
     */
    public static String int2ArgbString(@android.support.annotation.ColorInt final int colorInt) {
        String color = Integer.toHexString(colorInt);
        while (color.length() < 6) {
            color = "0" + color;
        }
