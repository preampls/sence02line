...
public final class CleanUtils {
    ...
    public static boolean cleanInternalDbs() {
        return deleteFilesInDir(new java.io.File(Utils.getApp().getFilesDir().getParent(), "databases"));
    }
    ...
    public static boolean cleanInternalSp() {
        return deleteFilesInDir(new java.io.File(Utils.getApp().getFilesDir().getParent(), "shared_prefs"));
    }
     ...
     * @return {@code true}: success<br>{@code false}: fail
     */
    public static boolean cleanCustomDir(final java.io.File dir) {
    ...
    private static boolean deleteFilesInDir(final java.io.File dir) {
    ...
    private static boolean deleteDir(final java.io.File dir) {
        if (dir == null) return false;
        // dir doesn't exist then return true
        if (!dir.exists()) return true;
        // dir isn't a directory then return false
