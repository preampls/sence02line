...
public final class IntentUtils {
     ...
     */
    public static boolean isIntentAvailable(final android.content.Intent intent) {
        return Utils.getApp()
                .getPackageManager()
     ...
     * @return the intent of install app
     */
    public static android.content.Intent getInstallAppIntent(final String filePath) {
     ...
     * @return the intent of install app
     */
    public static android.content.Intent getInstallAppIntent(final java.io.File file) {
     ...
     * @return the intent of install app
     */
    public static android.content.Intent getInstallAppIntent(final String filePath, final boolean isNewTask) {
     ...
     * @return the intent of install app
     */
    public static android.content.Intent getInstallAppIntent(final java.io.File file, final boolean isNewTask) {
     ...
     * @return the intent of uninstall app
     */
    public static android.content.Intent getUninstallAppIntent(final String packageName) {
     ...
     * @return the intent of uninstall app
     */
    public static android.content.Intent getUninstallAppIntent(final String packageName, final boolean isNewTask) {
     ...
     * @return the intent of launch app
     */
    public static android.content.Intent getLaunchAppIntent(final String packageName) {
     ...
     * @return the intent of launch app
     */
    public static android.content.Intent getLaunchAppIntent(final String packageName, final boolean isNewTask) {
        android.content.Intent intent = Utils.getApp().getPackageManager().getLaunchIntentForPackage(packageName);
     ...
     * @return the intent of launch app details settings
     */
    public static android.content.Intent getLaunchAppDetailsSettingsIntent(final String packageName) {
     ...
     * @return the intent of share text
     */
    public static android.content.Intent getShareTextIntent(final String content) {
    ...
    public static android.content.Intent getShareTextIntent(final String content, final boolean isNewTask) {
     ...
     * @return the intent of share image
     */
    public static android.content.Intent getShareImageIntent(final String content, final String imagePath) {
     ...
     * @return the intent of share image
     */
    public static android.content.Intent getShareImageIntent(final String content,
                                                             final String imagePath,
                                                             final boolean isNewTask) {
        if (imagePath == null || imagePath.length() == 0) return null;
        return getShareImageIntent(content, new java.io.File(imagePath), isNewTask);
    }
     ...
     * @return the intent of share image
     */
    public static android.content.Intent getShareImageIntent(final String content, final java.io.File image) {
     ...
     * @return the intent of share image
     */
    public static android.content.Intent getShareImageIntent(final String content, final android.net.Uri uri) {
     ...
     * @return the intent of share images
     */
    public static android.content.Intent getShareImageIntent(final String content, final java.util.LinkedList<String> imagePaths) {
     ...
     * @return the intent of share images
     */
    public static android.content.Intent getShareImageIntent(final String content, final java.util.List<java.io.File> images) {
     ...
     */
    public static android.content.Intent getShareImageIntent(final String content,
                                                             final java.util.List<java.io.File> images,
                                                             final boolean isNewTask) {
     ...
     * @return the intent of share images
     */
    public static android.content.Intent getShareImageIntent(final String content, final java.util.ArrayList<android.net.Uri> uris) {
     ...
     */
    public static android.content.Intent getShareImageIntent(final String content,
                                                             final java.util.ArrayList<android.net.Uri> uris,
                                                             final boolean isNewTask) {
     ...
     * @return the intent of component
     */
    public static android.content.Intent getComponentIntent(final String packageName, final String className) {
     ...
     * @return the intent of component
     */
    public static android.content.Intent getComponentIntent(final String packageName,
    ...
    public static android.content.Intent getComponentIntent(final String packageName,
        ...
        android.content.ComponentName cn = new android.content.ComponentName(packageName, className);
     ...
     * @return the intent of shutdown
     */
    public static android.content.Intent getShutdownIntent(final boolean isNewTask) {
        android.content.Intent intent = new android.content.Intent("android.intent.action.ACTION_REQUEST_SHUTDOWN");
     ...
     * @return the intent of dial
     */
    public static android.content.Intent getDialIntent(final String phoneNumber) {
     ...
     * @return the intent of dial
     */
    public static android.content.Intent getDialIntent(final String phoneNumber, final boolean isNewTask) {
    ...
    public static android.content.Intent getCallIntent(final String phoneNumber) {
     ...
     */
    @android.support.annotation.RequiresPermission(CALL_PHONE)
    public static android.content.Intent getCallIntent(final String phoneNumber, final boolean isNewTask) {
        android.content.Intent intent = new android.content.Intent("android.intent.action.CALL", android.net.Uri.parse("tel:" + phoneNumber));
        return getIntent(intent, isNewTask);
    }
     ...
     * @return the intent of send SMS
     */
    public static android.content.Intent getSendSmsIntent(final String phoneNumber, final String content) {
     ...
     * @return the intent of send SMS
     */
    public static android.content.Intent getSendSmsIntent(final String phoneNumber,
     ...
     * @return the intent of capture
     */
    public static android.content.Intent getCaptureIntent(final android.net.Uri outUri) {
     ...
     * @return the intent of capture
     */
    public static android.content.Intent getCaptureIntent(final android.net.Uri outUri, final boolean isNewTask) {
    ...
    private static android.content.Intent getIntent(final android.content.Intent intent, final boolean isNewTask) {
    ...
    private static android.net.Uri file2Uri(final java.io.File file) {
        if (file == null) return null;
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.N) {
            String authority = Utils.getApp().getPackageName() + ".utilcode.provider";
